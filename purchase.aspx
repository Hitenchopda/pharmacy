<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="purchase.aspx.cs" Inherits="pharmacy.purchase" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div style="margin-left:35rem;margin-top:5rem;margin-right:15rem;">
        <h3 class="text-primary">Purchases <label id="message" class="text-primary" runat="server" style="font-size:large;margin-left:20rem"></label></h3>
    <asp:GridView ID="GridView1" runat="server"  ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" CellPadding="4" Width="785px" EnableViewState="False" OnRowDeleting="GridView1_RowDeleting">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="pid" HeaderText="Purchase id" />
            <asp:BoundField DataField="pdate" HeaderText="Date" />
            <asp:BoundField DataField="med" HeaderText="Medicine" />
